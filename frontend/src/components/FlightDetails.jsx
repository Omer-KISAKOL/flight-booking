...
export const FlightDetails = ({ flight, onClose , handleFlightSubmit , transferAirport, finalDestination}) => {
        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-8 rounded-lg w-[65%] shadow-lg relative">
                ...
                <div className="mt-20 flex relative">
                    <button
                        className="bg-purple-800 absolute -bottom-8 -right-8 text-white py-6 px-12 text-xl rounded-book"
